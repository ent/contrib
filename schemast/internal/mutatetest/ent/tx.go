...
func (tx *Tx) init() {
	...
	tx.WithFields = NewWithFieldsClient(tx.config)
	tx.WithModifiedField = NewWithModifiedFieldClient(tx.config)
	tx.WithNilFields = NewWithNilFieldsClient(tx.config)
	tx.WithoutFields = NewWithoutFieldsClient(tx.config)
}

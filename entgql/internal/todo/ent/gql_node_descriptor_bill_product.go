...
func init() {
	registerNodeDescriptor(billproduct.Table, func(ctx context.Context, n Noder) (*Node, error) {
		return BillProductNode(n.(*BillProduct), ctx)
	})
}

// BillProductNode returns the Node representation of a BillProduct.

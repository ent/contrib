...
// SpecialTextMutation represents an operation that mutates the SpecialText nodes in the graph.
type SpecialTextMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*SpecialText, error)
	predicates    []predicate.SpecialText
}

var _ ent.Mutation = (*SpecialTextMutation)(nil)

// specialtextOption allows management of the mutation configuration using functional options.
type specialtextOption func(*SpecialTextMutation)

// newSpecialTextMutation creates new mutation for the SpecialText entity.
func newSpecialTextMutation(c config, op Op, opts ...specialtextOption) *SpecialTextMutation {
	m := &SpecialTextMutation{
		config:        c,
		op:            op,
		typ:           TypeSpecialText,
		clearedFields: make(map[string]struct{}),
...
// withSpecialTextID sets the ID field of the mutation.
func withSpecialTextID(id int) specialtextOption {
	return func(m *SpecialTextMutation) {
		var (
			err   error
			once  sync.Once
			value *SpecialText
		)
		m.oldValue = func(ctx context.Context) (*SpecialText, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SpecialText.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSpecialText sets the old SpecialText of the mutation.
func withSpecialText(node *SpecialText) specialtextOption {
	return func(m *SpecialTextMutation) {
		m.oldValue = func(context.Context) (*SpecialText, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SpecialTextMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SpecialTextMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SpecialTextMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SpecialTextMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SpecialText.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *SpecialTextMutation) SetContent(s string) {
	m.content = &s
}

// Content returns the value of the "content" field in the mutation.
func (m *SpecialTextMutation) Content() (r string, exists bool) {
	v := m.content
	if v == nil {
		return
	}
...
// OldContent returns the old "content" field's value of the SpecialText entity.
// If the SpecialText object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SpecialTextMutation) OldContent(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SpecialTextMutation) ResetContent() {
	m.content = nil
}

// Where appends a list predicates to the SpecialTextMutation builder.
func (m *SpecialTextMutation) Where(ps ...predicate.SpecialText) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the SpecialTextMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SpecialTextMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SpecialText, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SpecialTextMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SpecialTextMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SpecialText).
func (m *SpecialTextMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *SpecialTextMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.content != nil {
		fields = append(fields, specialtext.FieldContent)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SpecialTextMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SpecialTextMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case specialtext.FieldContent:
		return m.OldContent(ctx)
	}
	return nil, fmt.Errorf("unknown SpecialText field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SpecialTextMutation) SetField(name string, value ent.Value) error {
	switch name {
	case specialtext.FieldContent:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown SpecialText field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *SpecialTextMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SpecialTextMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SpecialTextMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown SpecialText numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SpecialTextMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SpecialTextMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SpecialTextMutation) ClearField(name string) error {
	return fmt.Errorf("unknown SpecialText nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SpecialTextMutation) ResetField(name string) error {
	switch name {
	case specialtext.FieldContent:
		m.ResetContent()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SpecialTextMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SpecialTextMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SpecialTextMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SpecialTextMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SpecialTextMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SpecialTextMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SpecialTextMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown SpecialText unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SpecialTextMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown SpecialText edge %s", name)
}

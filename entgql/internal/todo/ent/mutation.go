...
func (m *ProjectMutation) ClearTodo() {
	m.clearedtodo = true
}

// TodoCleared reports if the "todo" edge to the Todo entity was cleared.
func (m *ProjectMutation) TodoCleared() bool {
...
func (m *ProjectMutation) RemovedTodoIDs() (ids []int) {
...
func (m *ProjectMutation) TodoIDs() (ids []int) {
	for id := range m.todo {
		ids = append(ids, id)
	}
	return
...
func (m *ProjectMutation) ResetTodo() {
	m.todo = nil
	m.clearedtodo = false
	m.removedtodo = nil
}
...
func (m *ProjectMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.todo != nil {
		edges = append(edges, project.EdgeTodo)
	}
	return edges
}

...
func init() {
	registerNodeResolver(friendship.Table, nodeResolver{
		byID:  friendshipNoder,
		byIDs: friendshipNoders,
	})
}

func friendshipNoder(ctx context.Context, c *Client, id int) (Noder, error) {
...
func friendshipNoders(ctx context.Context, c *Client, ids []int, idmap map[int][]*Noder) error {
	query := c.Friendship.Query().

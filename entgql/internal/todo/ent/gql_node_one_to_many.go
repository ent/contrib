...
func init() {
	registerNodeResolver(onetomany.Table, nodeResolver{
		byID:  onetomanyNoder,
		byIDs: onetomanyNoders,
	})
}

func onetomanyNoder(ctx context.Context, c *Client, id int) (Noder, error) {
...
func onetomanyNoders(ctx context.Context, c *Client, ids []int, idmap map[int][]*Noder) error {
	query := c.OneToMany.Query().

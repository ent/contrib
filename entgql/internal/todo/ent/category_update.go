...
func (cu *CategoryUpdate) AddProjectIDs(ids ...int) *CategoryUpdate {
...
func (cu *CategoryUpdate) RemoveProjectIDs(ids ...int) *CategoryUpdate {
...
// AddProjectIDs adds the "projects" edge to the Project entity by IDs.
func (cuo *CategoryUpdateOne) AddProjectIDs(ids ...int) *CategoryUpdateOne {
...
// RemoveProjectIDs removes the "projects" edge to Project entities by IDs.
func (cuo *CategoryUpdateOne) RemoveProjectIDs(ids ...int) *CategoryUpdateOne {

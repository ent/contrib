...
func (i *BillProductWhereInput) Filter(q *BillProductQuery) (*BillProductQuery, error) {
	...
	p, err := i.P()
	if err != nil {
		if errors.Is(err, ErrEmptyBillProductWhereInput) {
			return q, nil
		}
		return nil, err
	}
...
func (i *FriendshipWhereInput) Filter(q *FriendshipQuery) (*FriendshipQuery, error) {
	...
	p, err := i.P()
	if err != nil {
		if errors.Is(err, ErrEmptyFriendshipWhereInput) {
			return q, nil
		}
		return nil, err
	}
...
func (i *GroupWhereInput) Filter(q *GroupQuery) (*GroupQuery, error) {
	...
	p, err := i.P()
	if err != nil {
		if errors.Is(err, ErrEmptyGroupWhereInput) {
			return q, nil
		}
		return nil, err
	}
...
func (i *OneToManyWhereInput) Filter(q *OneToManyQuery) (*OneToManyQuery, error) {
	...
	p, err := i.P()
	if err != nil {
		if errors.Is(err, ErrEmptyOneToManyWhereInput) {
			return q, nil
		}
		return nil, err
	}
...
func (i *ProjectWhereInput) Filter(q *ProjectQuery) (*ProjectQuery, error) {
	...
	p, err := i.P()
	if err != nil {
		if errors.Is(err, ErrEmptyProjectWhereInput) {
			return q, nil
		}
		return nil, err
	}

...
func (r *queryResolver) Bookmarks(ctx context.Context, after *entgql.Cursor[int], first *int, before *entgql.Cursor[int], last *int, where *ent.BookmarkWhereInput) (*ent.BookmarkConnection, error) {
	return r.client.Bookmark.Query().
		Paginate(ctx, after, first, before, last,
			ent.WithBookmarkFilter(where.Filter),
		)
}

// BookmarkItems is the resolver for the bookmarkItems field. The pagination,
// ordering and filtering logic is generated by entgql on the view query builder
// (PaginateBookmarkItem), which paginates the BookmarkItemView at the database
// level and resolves each row to its concrete node (Todo/Project).
func (r *queryResolver) BookmarkItems(ctx context.Context, after *entgql.Cursor[int], first *int, before *entgql.Cursor[int], last *int, orderBy *ent.BookmarkItemOrder, where *ent.BookmarkItemWhereInput) (*ent.BookmarkItemConnection, error) {
	return r.client.BookmarkItemView.Query().PaginateBookmarkItem(ctx, after, first, before, last, orderBy, where)
}

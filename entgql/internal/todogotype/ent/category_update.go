...
func (cu *CategoryUpdate) AddProjectIDs(ids ...bigintgql.BigInt) *CategoryUpdate {
...
func (cu *CategoryUpdate) AddProjects(p ...*Project) *CategoryUpdate {
	ids := make([]bigintgql.BigInt, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
func (cu *CategoryUpdate) RemoveProjectIDs(ids ...bigintgql.BigInt) *CategoryUpdate {
...
// AddProjectIDs adds the "projects" edge to the Project entity by IDs.
func (cuo *CategoryUpdateOne) AddProjectIDs(ids ...bigintgql.BigInt) *CategoryUpdateOne {
...
// RemoveProjectIDs removes the "projects" edge to Project entities by IDs.
func (cuo *CategoryUpdateOne) RemoveProjectIDs(ids ...bigintgql.BigInt) *CategoryUpdateOne {

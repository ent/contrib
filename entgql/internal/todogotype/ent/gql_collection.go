...
// CollectFields tells the query-builder to eagerly load connected nodes by resolver context.
func (q *PetQuery) CollectFields(ctx context.Context, satisfies ...string) (*PetQuery, error) {
	fc := graphql.GetFieldContext(ctx)
	if fc == nil {
		return q, nil
	}
...
func (q *PetQuery) collectField(ctx context.Context, op *graphql.OperationContext, field graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}

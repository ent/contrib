...
func (pq *ProjectQuery) FirstID(ctx context.Context) (id bigintgql.BigInt, err error) {
...
func (pq *ProjectQuery) FirstIDX(ctx context.Context) bigintgql.BigInt {
...
func (pq *ProjectQuery) OnlyID(ctx context.Context) (id bigintgql.BigInt, err error) {
	var ids []bigintgql.BigInt
...
func (pq *ProjectQuery) OnlyIDX(ctx context.Context) bigintgql.BigInt {
...
func (pq *ProjectQuery) IDs(ctx context.Context) (ids []bigintgql.BigInt, err error) {
...
func (pq *ProjectQuery) IDsX(ctx context.Context) []bigintgql.BigInt {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *ProjectQuery) loadTodos(ctx context.Context, query *TodoQuery, nodes []*Project, init func(*Project), assign func(*Project, *Todo)) error {
	...
	nodeids := make(map[bigintgql.BigInt]*Project)
	for i := range nodes {

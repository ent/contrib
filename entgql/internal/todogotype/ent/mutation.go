...
type CategoryMutation struct {
	...
	clearedtodos          bool
	projects              map[bigintgql.BigInt]struct{}
	removedprojects       map[bigintgql.BigInt]struct{}
...
func (m *CategoryMutation) AddProjectIDs(ids ...bigintgql.BigInt) {
	if m.projects == nil {
		m.projects = make(map[bigintgql.BigInt]struct{})
	}
	for i := range ids {
...
func (m *CategoryMutation) RemoveProjectIDs(ids ...bigintgql.BigInt) {
	if m.removedprojects == nil {
		m.removedprojects = make(map[bigintgql.BigInt]struct{})
	}
	for i := range ids {
...
func (m *CategoryMutation) RemovedProjectsIDs() (ids []bigintgql.BigInt) {
...
func (m *CategoryMutation) ProjectsIDs() (ids []bigintgql.BigInt) {
...
func withProjectID(id bigintgql.BigInt) projectOption {
...
func (m *ProjectMutation) SetID(id bigintgql.BigInt) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ProjectMutation) ID() (id bigintgql.BigInt, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ProjectMutation) IDs(ctx context.Context) ([]bigintgql.BigInt, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
// AddTodoIDs adds the "todos" edge to the Todo entity by ids.
func (m *ProjectMutation) AddTodoIDs(ids ...string) {
	if m.todos == nil {
		m.todos = make(map[string]struct{})
	}
	for i := range ids {
...
// RemoveTodoIDs removes the "todos" edge to the Todo entity by IDs.
func (m *ProjectMutation) RemoveTodoIDs(ids ...string) {
	if m.removedtodos == nil {
		m.removedtodos = make(map[string]struct{})
	}
	for i := range ids {
...
// RemovedTodos returns the removed IDs of the "todos" edge to the Todo entity.
func (m *ProjectMutation) RemovedTodosIDs() (ids []string) {
	for id := range m.removedtodos {
		ids = append(ids, id)
	}
	return
...
// TodosIDs returns the "todos" edge IDs in the mutation.
func (m *ProjectMutation) TodosIDs() (ids []string) {
	for id := range m.todos {
		ids = append(ids, id)
	}
	return
...
func (m *ProjectMutation) SetCategoryID(id bigintgql.BigInt) {
	m.category = &id
}
...
func (m *ProjectMutation) CategoryID() (id bigintgql.BigInt, exists bool) {
	if m.category != nil {
...
func (m *ProjectMutation) CategoryIDs() (ids []bigintgql.BigInt) {

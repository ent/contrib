...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	switch table {
	case clashingtext.Table:
		query := c.ClashingText.Query().
			Where(clashingtext.ID(id))
		query, err := query.CollectFields(ctx, "ClashingText")
		if err != nil {
			return nil, err
		}

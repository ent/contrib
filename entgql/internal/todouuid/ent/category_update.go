...
func (cu *CategoryUpdate) AddProjectIDs(ids ...uuid.UUID) *CategoryUpdate {
...
func (cu *CategoryUpdate) RemoveProjectIDs(ids ...uuid.UUID) *CategoryUpdate {
...
// AddProjectIDs adds the "projects" edge to the Project entity by IDs.
func (cuo *CategoryUpdateOne) AddProjectIDs(ids ...uuid.UUID) *CategoryUpdateOne {
...
// RemoveProjectIDs removes the "projects" edge to Project entities by IDs.
func (cuo *CategoryUpdateOne) RemoveProjectIDs(ids ...uuid.UUID) *CategoryUpdateOne {

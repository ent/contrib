...
func (pc *ProjectCreate) AddTodoIDs(ids ...uuid.UUID) *ProjectCreate {
...
func (pc *ProjectCreate) SetCategoryID(id uuid.UUID) *ProjectCreate {
	pc.mutation.SetCategoryID(id)
	return pc
}

// SetNillableCategoryID sets the "category" edge to the Category entity by ID if the given value is not nil.
func (pc *ProjectCreate) SetNillableCategoryID(id *uuid.UUID) *ProjectCreate {
	if id != nil {

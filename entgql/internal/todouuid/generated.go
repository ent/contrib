...
func (ec *executionContext) _Query_directiveExamples(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDirectiveExample2ᚕᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputDirectiveExampleWhereInput(ctx context.Context, obj any) (DirectiveExampleWhereInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "not":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("not"))
			data, err := ec.unmarshalODirectiveExampleWhereInput2ᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleWhereInput(ctx, v)
			if err != nil {
				return it, err
			}
			it.Not = data
		case "and":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("and"))
			data, err := ec.unmarshalODirectiveExampleWhereInput2ᚕᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleWhereInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.And = data
...
func (ec *executionContext) marshalNDirectiveExample2ᚕᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleᚄ(ctx context.Context, sel ast.SelectionSet, v []*DirectiveExample) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDirectiveExample2ᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExample(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDirectiveExample2ᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExample(ctx context.Context, sel ast.SelectionSet, v *DirectiveExample) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNDirectiveExampleWhereInput2ᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleWhereInput(ctx context.Context, v any) (*DirectiveExampleWhereInput, error) {
...
func (ec *executionContext) unmarshalODirectiveExampleWhereInput2ᚕᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleWhereInputᚄ(ctx context.Context, v any) ([]*DirectiveExampleWhereInput, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []any
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNDirectiveExampleWhereInput2ᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleWhereInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalODirectiveExampleWhereInput2ᚖentgoᚗioᚋcontribᚋentgqlᚋinternalᚋtodouuidᚐDirectiveExampleWhereInput(ctx context.Context, v any) (*DirectiveExampleWhereInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputDirectiveExampleWhereInput(ctx, v)

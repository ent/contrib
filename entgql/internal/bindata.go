...
func templateNodeTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/node.tmpl", size: 9703, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

...
func (m *DocumentMutation) SetGlobalID(i int) {
	m.global_id = &i
	m.addglobal_id = nil
}

// GlobalID returns the value of the "global_id" field in the mutation.
func (m *DocumentMutation) GlobalID() (r int, exists bool) {
	v := m.global_id
	if v == nil {
		return
	}
...
// OldGlobalID returns the old "global_id" field's value of the Document entity.
// If the Document object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *DocumentMutation) OldGlobalID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldGlobalID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldGlobalID requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldGlobalID: %w", err)
	}
	return oldValue.GlobalID, nil
}

// AddGlobalID adds i to the "global_id" field.
func (m *DocumentMutation) AddGlobalID(i int) {
	if m.addglobal_id != nil {
		*m.addglobal_id += i
	} else {
		m.addglobal_id = &i
	}
...
// AddedGlobalID returns the value that was added to the "global_id" field in this mutation.
func (m *DocumentMutation) AddedGlobalID() (r int, exists bool) {
	v := m.addglobal_id
	if v == nil {
		return
	}
...
// ResetGlobalID resets all changes to the "global_id" field.
func (m *DocumentMutation) ResetGlobalID() {
	m.global_id = nil
	m.addglobal_id = nil
}
...
func (m *DocumentMutation) Fields() []string {
	...
	if m.global_id != nil {
		fields = append(fields, document.FieldGlobalID)
	}
	if m.name != nil {

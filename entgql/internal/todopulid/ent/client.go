...
// UpdateOneID returns an update builder for the given id.
func (c *ProjectClient) UpdateOneID(id pulid.ID) *ProjectUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ProjectClient) DeleteOneID(id pulid.ID) *ProjectDeleteOne {
...
func (c *ProjectClient) Get(ctx context.Context, id pulid.ID) (*Project, error) {
	return c.Query().Where(project.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ProjectClient) GetX(ctx context.Context, id pulid.ID) *Project {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}

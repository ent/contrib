...
func (pc *ProjectCreate) SetID(pu pulid.ID) *ProjectCreate {
	pc.mutation.SetID(pu)
	return pc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (pc *ProjectCreate) SetNillableID(pu *pulid.ID) *ProjectCreate {
	if pu != nil {
		pc.SetID(*pu)
	}
	return pc
...
func (pc *ProjectCreate) AddTodoIDs(ids ...pulid.ID) *ProjectCreate {
...
func (pc *ProjectCreate) SetCategoryID(id pulid.ID) *ProjectCreate {
	pc.mutation.SetCategoryID(id)
	return pc
}

// SetNillableCategoryID sets the "category" edge to the Category entity by ID if the given value is not nil.
func (pc *ProjectCreate) SetNillableCategoryID(id *pulid.ID) *ProjectCreate {
	if id != nil {

...
func (pq *ProjectQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (pq *ProjectQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (pq *ProjectQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (pq *ProjectQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (pq *ProjectQuery) IDs(ctx context.Context) (ids []pulid.ID, err error) {
...
func (pq *ProjectQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *ProjectQuery) loadTodos(ctx context.Context, query *TodoQuery, nodes []*Project, init func(*Project), assign func(*Project, *Todo)) error {
	...
	nodeids := make(map[pulid.ID]*Project)
	for i := range nodes {

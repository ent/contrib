...
type CategoryMutation struct {
	...
	clearedtodos          bool
	projects              map[pulid.ID]struct{}
	removedprojects       map[pulid.ID]struct{}
...
func (m *CategoryMutation) AddProjectIDs(ids ...pulid.ID) {
	if m.projects == nil {
		m.projects = make(map[pulid.ID]struct{})
	}
	for i := range ids {
...
func (m *CategoryMutation) RemoveProjectIDs(ids ...pulid.ID) {
	if m.removedprojects == nil {
		m.removedprojects = make(map[pulid.ID]struct{})
	}
	for i := range ids {
...
func (m *CategoryMutation) RemovedProjectsIDs() (ids []pulid.ID) {
...
func (m *CategoryMutation) ProjectsIDs() (ids []pulid.ID) {
...
func withProjectID(id pulid.ID) projectOption {
...
func (m *ProjectMutation) SetID(id pulid.ID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ProjectMutation) ID() (id pulid.ID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ProjectMutation) IDs(ctx context.Context) ([]pulid.ID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
// AddTodoIDs adds the "todos" edge to the Todo entity by ids.
func (m *ProjectMutation) AddTodoIDs(ids ...pulid.ID) {
	if m.todos == nil {
		m.todos = make(map[pulid.ID]struct{})
	}
	for i := range ids {
...
// RemoveTodoIDs removes the "todos" edge to the Todo entity by IDs.
func (m *ProjectMutation) RemoveTodoIDs(ids ...pulid.ID) {
	if m.removedtodos == nil {
		m.removedtodos = make(map[pulid.ID]struct{})
	}
	for i := range ids {
...
// RemovedTodos returns the removed IDs of the "todos" edge to the Todo entity.
func (m *ProjectMutation) RemovedTodosIDs() (ids []pulid.ID) {
	for id := range m.removedtodos {
		ids = append(ids, id)
	}
	return
...
// TodosIDs returns the "todos" edge IDs in the mutation.
func (m *ProjectMutation) TodosIDs() (ids []pulid.ID) {
	for id := range m.todos {
		ids = append(ids, id)
	}
	return
...
func (m *ProjectMutation) SetCategoryID(id pulid.ID) {
	m.category = &id
}
...
func (m *ProjectMutation) CategoryID() (id pulid.ID, exists bool) {
	if m.category != nil {
...
func (m *ProjectMutation) CategoryIDs() (ids []pulid.ID) {

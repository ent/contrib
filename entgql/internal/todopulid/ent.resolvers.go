...
func (r *queryResolver) Bookmarks(ctx context.Context, after *entgql.Cursor[pulid.ID], first *int, before *entgql.Cursor[pulid.ID], last *int, where *BookmarkWhereInput) (*BookmarkConnection, error) {
	panic(fmt.Errorf("not implemented: Bookmarks - bookmarks"))
}

// BookmarkItems is the resolver for the bookmarkItems field.
func (r *queryResolver) BookmarkItems(ctx context.Context, after *entgql.Cursor[pulid.ID], first *int, before *entgql.Cursor[pulid.ID], last *int, orderBy *BookmarkItemOrder, where *BookmarkItemWhereInput) (*BookmarkItemConnection, error) {

...
Download the module:
```console
go get -u github.com/bionicstork/bionicstork/pkg/entproto
```

Install `protoc-gen-entgrpc` (ent's gRPC service implementation generator): 
```console
go get github.com/bionicstork/bionicstork/pkg/entproto/cmd/protoc-gen-entgrpc
```
...
```console
go run github.com/bionicstork/bionicstork/pkg/entproto/cmd/entproto -path ./ent/schema
```
...
option go_package = "github.com/bionicstork/bionicstork/pkg/entproto/internal/todo/ent/proto/entpb";

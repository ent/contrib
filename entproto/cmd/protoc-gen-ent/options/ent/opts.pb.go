...
func file_opts_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_opts_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Schema); i {
			case 0:
				return &v.state
			case 1:
		...
		file_opts_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Field); i {
			case 0:
				return &v.state
			case 1:
		...
		file_opts_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Edge); i {
			case 0:
				return &v.state
			case 1:
		...
		file_opts_proto_msgTypes[4].Exporter = func(v any, i int) any {

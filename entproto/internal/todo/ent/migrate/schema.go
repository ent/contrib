...
var (
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "custom_int", Type: field.TypeInt, Nullable: true},
		{Name: "custom_int8", Type: field.TypeInt8, Nullable: true},
		{Name: "custom_int16", Type: field.TypeInt16, Nullable: true},
		{Name: "custom_int32", Type: field.TypeInt32, Nullable: true},
		{Name: "custom_int64", Type: field.TypeInt64, Nullable: true},
		{Name: "custom_uint", Type: field.TypeUint, Nullable: true},
		{Name: "custom_uint8", Type: field.TypeUint8, Nullable: true},
		{Name: "custom_uint16", Type: field.TypeUint16, Nullable: true},
		{Name: "custom_uint32", Type: field.TypeUint32, Nullable: true},
		{Name: "custom_uint64", Type: field.TypeUint64, Nullable: true},
		{Name: "custom_float32", Type: field.TypeFloat32, Nullable: true},
		{Name: "custom_float64", Type: field.TypeFloat64, Nullable: true},
		{Name: "custom_string", Type: field.TypeString, Nullable: true},
		{Name: "custom_bool", Type: field.TypeBool, Nullable: true},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{UsersColumns[41]},

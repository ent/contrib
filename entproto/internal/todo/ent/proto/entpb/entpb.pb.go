...
type User struct {
	...
	OptNum         *wrappers.Int64Value  `protobuf:"bytes,13,opt,name=opt_num,json=optNum,proto3" json:"opt_num,omitempty"`
	...
	BUser_1        *wrappers.Int64Value  `protobuf:"bytes,18,opt,name=b_user_1,json=bUser1,proto3" json:"b_user_1,omitempty"`
	...
	Type           *wrappers.StringValue `protobuf:"bytes,23,opt,name=type,proto3" json:"type,omitempty"`
...
var file_entpb_entpb_proto_goTypes = []interface{}{
	...
	(*wrappers.StringValue)(nil),                // 67: google.protobuf.StringValue

...
var file_entpb_entpb_proto_rawDesc = []byte{
	...
	0x10, 0x02, 0x22, 0xc6, 0x05, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x75, 0x65, 0x52, 0x06, 0x62, 0x69, 0x67, 0x49, 0x6e, 0x74, 0x12, 0x22, 0x0a, 0x05, 0x67, 0x72,
	...
	0x74, 0x12, 0x2d, 0x0a, 0x08, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x18, 0x10, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x41, 0x74, 0x74, 0x61,
	0x63, 0x68, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x08, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x32, 0x86, 0x02, 0x0a, 0x11,
	...
	0x6d, 0x70, 0x74, 0x79, 0x32, 0xd6, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
...
var file_entpb_entpb_proto_depIdxs = []int32{
	...
	18, // 13: entpb.User.big_int:type_name -> google.protobuf.StringValue
	9,  // 14: entpb.User.group:type_name -> entpb.Group
	4,  // 15: entpb.User.attachment:type_name -> entpb.Attachment
	4,  // 16: entpb.User.received:type_name -> entpb.Attachment
	11, // 17: entpb.CreateUserRequest.user:type_name -> entpb.User
	3,  // 18: entpb.GetUserRequest.view:type_name -> entpb.GetUserRequest.View
	11, // 19: entpb.UpdateUserRequest.user:type_name -> entpb.User
	5,  // 20: entpb.AttachmentService.Create:input_type -> entpb.CreateAttachmentRequest
	6,  // 21: entpb.AttachmentService.Get:input_type -> entpb.GetAttachmentRequest
	7,  // 22: entpb.AttachmentService.Update:input_type -> entpb.UpdateAttachmentRequest
	8,  // 23: entpb.AttachmentService.Delete:input_type -> entpb.DeleteAttachmentRequest
	12, // 24: entpb.UserService.Create:input_type -> entpb.CreateUserRequest
	13, // 25: entpb.UserService.Get:input_type -> entpb.GetUserRequest
	14, // 26: entpb.UserService.Update:input_type -> entpb.UpdateUserRequest
	15, // 27: entpb.UserService.Delete:input_type -> entpb.DeleteUserRequest
	4,  // 28: entpb.AttachmentService.Create:output_type -> entpb.Attachment
	4,  // 29: entpb.AttachmentService.Get:output_type -> entpb.Attachment
	4,  // 30: entpb.AttachmentService.Update:output_type -> entpb.Attachment
	20, // 31: entpb.AttachmentService.Delete:output_type -> google.protobuf.Empty
	11, // 32: entpb.UserService.Create:output_type -> entpb.User
	11, // 33: entpb.UserService.Get:output_type -> entpb.User
	11, // 34: entpb.UserService.Update:output_type -> entpb.User
	20, // 35: entpb.UserService.Delete:output_type -> google.protobuf.Empty

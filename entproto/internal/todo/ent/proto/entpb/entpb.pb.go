...
var file_entpb_entpb_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1c, 0x0a, 0x0a, 0x41, 0x74, 0x74, 0x61,
	...
	0x10, 0x02, 0x22, 0xd4, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x01, 0x28, 0x0c, 0x52, 0x05, 0x63, 0x72, 0x6d, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x05, 0x67, 0x72,
	0x6f, 0x75, 0x70, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x65, 0x6e, 0x74, 0x70,
	0x62, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x22, 0x39,
	...
	0x64, 0x22, 0x34, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x32, 0xd6, 0x01, 0x0a,
...
var file_entpb_entpb_proto_goTypes = []interface{}{
	...
	(*Todo)(nil),                  // 4: entpb.Todo
	(*User)(nil),                  // 5: entpb.User
	(*CreateUserRequest)(nil),     // 6: entpb.CreateUserRequest
	(*GetUserRequest)(nil),        // 7: entpb.GetUserRequest
	(*UpdateUserRequest)(nil),     // 8: entpb.UpdateUserRequest
	(*DeleteUserRequest)(nil),     // 9: entpb.DeleteUserRequest
...
var file_entpb_entpb_proto_depIdxs = []int32{
	...
	5,  // 2: entpb.Todo.user:type_name -> entpb.User
	10, // 3: entpb.User.joined:type_name -> google.protobuf.Timestamp
	1,  // 4: entpb.User.status:type_name -> entpb.User.Status
	3,  // 5: entpb.User.group:type_name -> entpb.Group
	5,  // 6: entpb.CreateUserRequest.user:type_name -> entpb.User
	5,  // 7: entpb.UpdateUserRequest.user:type_name -> entpb.User
	6,  // 8: entpb.UserService.Create:input_type -> entpb.CreateUserRequest
	7,  // 9: entpb.UserService.Get:input_type -> entpb.GetUserRequest
	8,  // 10: entpb.UserService.Update:input_type -> entpb.UpdateUserRequest
	9,  // 11: entpb.UserService.Delete:input_type -> entpb.DeleteUserRequest
	5,  // 12: entpb.UserService.Create:output_type -> entpb.User
	5,  // 13: entpb.UserService.Get:output_type -> entpb.User
	5,  // 14: entpb.UserService.Update:output_type -> entpb.User
	11, // 15: entpb.UserService.Delete:output_type -> google.protobuf.Empty

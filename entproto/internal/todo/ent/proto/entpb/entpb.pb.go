...
var file_entpb_entpb_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x01, 0x0a, 0x04, 0x54, 0x6f, 0x64, 0x6f,
	...
	0x45, 0x10, 0x02, 0x22, 0x33, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x34, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61,
...
var file_entpb_entpb_proto_depIdxs = []int32{
	...
	2, // 2: entpb.CreateUserRequest.user:type_name -> entpb.User
	2, // 3: entpb.UpdateUserRequest.user:type_name -> entpb.User
	3, // 4: entpb.UserService.Create:input_type -> entpb.CreateUserRequest
	4, // 5: entpb.UserService.Get:input_type -> entpb.GetUserRequest
	5, // 6: entpb.UserService.Update:input_type -> entpb.UpdateUserRequest
	6, // 7: entpb.UserService.Delete:input_type -> entpb.DeleteUserRequest
	2, // 8: entpb.UserService.Create:output_type -> entpb.User
	2, // 9: entpb.UserService.Get:output_type -> entpb.User
	2, // 10: entpb.UserService.Update:output_type -> entpb.User
	7, // 11: entpb.UserService.Delete:output_type -> google.protobuf.Empty

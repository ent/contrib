...
var file_entpb_entpb_proto_rawDesc = []byte{
	...
	0x4e, 0x45, 0x10, 0x02, 0x22, 0xf8, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x61, 0x74, 0x75, 0x73, 0x22, 0x39, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16,
	...
	0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x34, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x69, 0x64, 0x32, 0xd6, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_entpb_entpb_proto_depIdxs = []int32{
	...
	3,  // 1: entpb.Todo.user:type_name -> entpb.User
	8,  // 2: entpb.User.joined:type_name -> google.protobuf.Timestamp
	1,  // 3: entpb.User.status:type_name -> entpb.User.Status
	3,  // 4: entpb.CreateUserRequest.user:type_name -> entpb.User
	3,  // 5: entpb.UpdateUserRequest.user:type_name -> entpb.User
	4,  // 6: entpb.UserService.Create:input_type -> entpb.CreateUserRequest
	5,  // 7: entpb.UserService.Get:input_type -> entpb.GetUserRequest
	6,  // 8: entpb.UserService.Update:input_type -> entpb.UpdateUserRequest
	7,  // 9: entpb.UserService.Delete:input_type -> entpb.DeleteUserRequest
	3,  // 10: entpb.UserService.Create:output_type -> entpb.User
	3,  // 11: entpb.UserService.Get:output_type -> entpb.User
	3,  // 12: entpb.UserService.Update:output_type -> entpb.User
	9,  // 13: entpb.UserService.Delete:output_type -> google.protobuf.Empty

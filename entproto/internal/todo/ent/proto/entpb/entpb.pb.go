...
type User struct {
	...
	Joined         *timestamp.Timestamp  `protobuf:"bytes,3,opt,name=joined,proto3" json:"joined,omitempty"`
	...
	OptNum         *wrappers.Int32Value  `protobuf:"bytes,13,opt,name=opt_num,json=optNum,proto3" json:"opt_num,omitempty"`
	OptStr         *wrappers.StringValue `protobuf:"bytes,14,opt,name=opt_str,json=optStr,proto3" json:"opt_str,omitempty"`
	OptBool        *wrappers.BoolValue   `protobuf:"bytes,15,opt,name=opt_bool,json=optBool,proto3" json:"opt_bool,omitempty"`
	BigInt         *wrappers.StringValue `protobuf:"bytes,17,opt,name=big_int,json=bigInt,proto3" json:"big_int,omitempty"`
	BUser_1        *wrappers.Int32Value  `protobuf:"bytes,18,opt,name=b_user_1,json=bUser1,proto3" json:"b_user_1,omitempty"`
...
func (x *User) GetOptNum() *wrappers.Int32Value {
	if x != nil {
		return x.OptNum
	}
	return nil
...
func (x *User) GetBUser_1() *wrappers.Int32Value {
	if x != nil {
		return x.BUser_1
	}
	return nil
...
var file_entpb_entpb_proto_goTypes = []interface{}{
	...
	(*wrappers.Int32Value)(nil),          // 52: google.protobuf.Int32Value

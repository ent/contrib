...
type MessageWithOptionalsQuery struct {
	config
	ctx        *QueryContext
	order      []messagewithoptionals.Order
	inters     []Interceptor
...
func (mwoq *MessageWithOptionalsQuery) Order(o ...messagewithoptionals.Order) *MessageWithOptionalsQuery {
...
func (mwoq *MessageWithOptionalsQuery) Clone() *MessageWithOptionalsQuery {
	...
	return &MessageWithOptionalsQuery{
		config:     mwoq.config,
		ctx:        mwoq.ctx.Clone(),
		order:      append([]messagewithoptionals.Order{}, mwoq.order...),

...
func (mweq *MessageWithEnumQuery) Order(o ...messagewithenum.Order) *MessageWithEnumQuery {
...
func (mweq *MessageWithEnumQuery) Clone() *MessageWithEnumQuery {
	...
	return &MessageWithEnumQuery{
		config:     mweq.config,
		ctx:        mweq.ctx.Clone(),
		order:      append([]messagewithenum.Order{}, mweq.order...),

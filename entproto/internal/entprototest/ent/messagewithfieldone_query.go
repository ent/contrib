...
type MessageWithFieldOneQuery struct {
	config
	ctx        *QueryContext
	order      []messagewithfieldone.Order
	inters     []Interceptor
...
func (mwfoq *MessageWithFieldOneQuery) Order(o ...messagewithfieldone.Order) *MessageWithFieldOneQuery {
...
func (mwfoq *MessageWithFieldOneQuery) Clone() *MessageWithFieldOneQuery {
	...
	return &MessageWithFieldOneQuery{
		config:     mwfoq.config,
		ctx:        mwfoq.ctx.Clone(),
		order:      append([]messagewithfieldone.Order{}, mwfoq.order...),

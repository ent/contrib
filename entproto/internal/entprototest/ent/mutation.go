...
const (
	...
	TypeMessageWithPhpNamespace  = "MessageWithPhpNamespace"
...
// MessageWithPhpNamespaceMutation represents an operation that mutates the MessageWithPhpNamespace nodes in the graph.
type MessageWithPhpNamespaceMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*MessageWithPhpNamespace, error)
	predicates    []predicate.MessageWithPhpNamespace
}

var _ ent.Mutation = (*MessageWithPhpNamespaceMutation)(nil)

// messagewithphpnamespaceOption allows management of the mutation configuration using functional options.
type messagewithphpnamespaceOption func(*MessageWithPhpNamespaceMutation)

// newMessageWithPhpNamespaceMutation creates new mutation for the MessageWithPhpNamespace entity.
func newMessageWithPhpNamespaceMutation(c config, op Op, opts ...messagewithphpnamespaceOption) *MessageWithPhpNamespaceMutation {
	m := &MessageWithPhpNamespaceMutation{
		config:        c,
		op:            op,
		typ:           TypeMessageWithPhpNamespace,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withMessageWithPhpNamespaceID sets the ID field of the mutation.
func withMessageWithPhpNamespaceID(id int) messagewithphpnamespaceOption {
	return func(m *MessageWithPhpNamespaceMutation) {
		var (
			err   error
			once  sync.Once
			value *MessageWithPhpNamespace
		)
		m.oldValue = func(ctx context.Context) (*MessageWithPhpNamespace, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().MessageWithPhpNamespace.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withMessageWithPhpNamespace sets the old MessageWithPhpNamespace of the mutation.
func withMessageWithPhpNamespace(node *MessageWithPhpNamespace) messagewithphpnamespaceOption {
	return func(m *MessageWithPhpNamespaceMutation) {
		m.oldValue = func(context.Context) (*MessageWithPhpNamespace, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m MessageWithPhpNamespaceMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m MessageWithPhpNamespaceMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *MessageWithPhpNamespaceMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *MessageWithPhpNamespaceMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().MessageWithPhpNamespace.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// Name returns the value of the "name" field in the mutation.
func (m *MessageWithPhpNamespaceMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the MessageWithPhpNamespace entity.
// If the MessageWithPhpNamespace object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MessageWithPhpNamespaceMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetName resets all changes to the "name" field.
func (m *MessageWithPhpNamespaceMutation) ResetName() {
	m.name = nil
}

// Where appends a list predicates to the MessageWithPhpNamespaceMutation builder.
func (m *MessageWithPhpNamespaceMutation) Where(ps ...predicate.MessageWithPhpNamespace) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the MessageWithPhpNamespaceMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MessageWithPhpNamespaceMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MessageWithPhpNamespace, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *MessageWithPhpNamespaceMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *MessageWithPhpNamespaceMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (MessageWithPhpNamespace).
func (m *MessageWithPhpNamespaceMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *MessageWithPhpNamespaceMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.name != nil {
		fields = append(fields, messagewithphpnamespace.FieldName)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *MessageWithPhpNamespaceMutation) Field(name string) (ent.Value, bool) {
	switch name {
	case messagewithphpnamespace.FieldName:
		return m.Name()
	}
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *MessageWithPhpNamespaceMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case messagewithphpnamespace.FieldName:
		return m.OldName(ctx)
	}
	return nil, fmt.Errorf("unknown MessageWithPhpNamespace field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MessageWithPhpNamespaceMutation) SetField(name string, value ent.Value) error {
	switch name {
	case messagewithphpnamespace.FieldName:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown MessageWithPhpNamespace field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *MessageWithPhpNamespaceMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *MessageWithPhpNamespaceMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MessageWithPhpNamespaceMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown MessageWithPhpNamespace numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *MessageWithPhpNamespaceMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *MessageWithPhpNamespaceMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *MessageWithPhpNamespaceMutation) ClearField(name string) error {
	return fmt.Errorf("unknown MessageWithPhpNamespace nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *MessageWithPhpNamespaceMutation) ResetField(name string) error {
	switch name {
	case messagewithphpnamespace.FieldName:
		m.ResetName()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *MessageWithPhpNamespaceMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *MessageWithPhpNamespaceMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *MessageWithPhpNamespaceMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *MessageWithPhpNamespaceMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *MessageWithPhpNamespaceMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *MessageWithPhpNamespaceMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *MessageWithPhpNamespaceMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown MessageWithPhpNamespace unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *MessageWithPhpNamespaceMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown MessageWithPhpNamespace edge %s", name)
}

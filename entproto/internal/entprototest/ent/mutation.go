...
func (m *MessageWithIntsMutation) SetInts(i []int) {
	m.ints = &i
	m.appendints = nil
}

// Ints returns the value of the "ints" field in the mutation.
func (m *MessageWithIntsMutation) Ints() (r []int, exists bool) {
	v := m.ints
	if v == nil {
		return
	}
...
// OldInts returns the old "ints" field's value of the MessageWithInts entity.
// If the MessageWithInts object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MessageWithIntsMutation) OldInts(ctx context.Context) (v []int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MessageWithIntsMutation) AppendInts(i []int) {
...
func (m *MessageWithIntsMutation) AppendedInts() ([]int, bool) {
...
func (m *MessageWithIntsMutation) ResetInts() {
	m.ints = nil
	m.appendints = nil
}
...
func (m *MessageWithIntsMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.ints != nil {
		fields = append(fields, messagewithints.FieldInts)
	}
	return fields
}

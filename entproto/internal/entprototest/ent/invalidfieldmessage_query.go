...
type InvalidFieldMessageQuery struct {
	config
	ctx        *QueryContext
	order      []invalidfieldmessage.Order
	inters     []Interceptor
...
func (ifmq *InvalidFieldMessageQuery) Order(o ...invalidfieldmessage.Order) *InvalidFieldMessageQuery {
...
func (ifmq *InvalidFieldMessageQuery) Clone() *InvalidFieldMessageQuery {
	...
	return &InvalidFieldMessageQuery{
		config:     ifmq.config,
		ctx:        ifmq.ctx.Clone(),
		order:      append([]invalidfieldmessage.Order{}, ifmq.order...),

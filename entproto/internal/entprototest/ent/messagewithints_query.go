...
func (mwiq *MessageWithIntsQuery) Order(o ...OrderFunc) *MessageWithIntsQuery {
...
func (mwiq *MessageWithIntsQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
//
//	client.MessageWithInts.Query().
//		Select(messagewithints.FieldInts).
//		Scan(ctx, &v)
func (mwiq *MessageWithIntsQuery) Select(fields ...string) *MessageWithIntsSelect {
	mwiq.fields = append(mwiq.fields, fields...)
	selbuild := &MessageWithIntsSelect{MessageWithIntsQuery: mwiq}
	selbuild.label = messagewithints.Label
...
func (mwiq *MessageWithIntsQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (mwigb *MessageWithIntsGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (mwigb *MessageWithIntsGroupBy) sqlQuery() *sql.Selector {
...
func (mwis *MessageWithIntsSelect) Scan(ctx context.Context, v any) error {
	...
	mwis.sql = mwis.MessageWithIntsQuery.sqlQuery(ctx)
	return mwis.sqlScan(ctx, v)
}

func (mwis *MessageWithIntsSelect) sqlScan(ctx context.Context, v any) error {

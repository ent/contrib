...
type ExplicitSkippedMessageQuery struct {
	config
	ctx        *QueryContext
	order      []explicitskippedmessage.Order
	inters     []Interceptor
...
func (esmq *ExplicitSkippedMessageQuery) Order(o ...explicitskippedmessage.Order) *ExplicitSkippedMessageQuery {
...
func (esmq *ExplicitSkippedMessageQuery) Clone() *ExplicitSkippedMessageQuery {
	...
	return &ExplicitSkippedMessageQuery{
		config:     esmq.config,
		ctx:        esmq.ctx.Clone(),
		order:      append([]explicitskippedmessage.Order{}, esmq.order...),

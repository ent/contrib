...
func (tmsq *TwoMethodServiceQuery) Order(o ...twomethodservice.Order) *TwoMethodServiceQuery {
...
func (tmsq *TwoMethodServiceQuery) Clone() *TwoMethodServiceQuery {
	...
	return &TwoMethodServiceQuery{
		config:     tmsq.config,
		ctx:        tmsq.ctx.Clone(),
		order:      append([]twomethodservice.Order{}, tmsq.order...),

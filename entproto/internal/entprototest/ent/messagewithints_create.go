...
func (mwic *MessageWithIntsCreate) SetInts(i []int) *MessageWithIntsCreate {
	mwic.mutation.SetInts(i)
	return mwic
}
...
func (mwic *MessageWithIntsCreate) check() error {
	if _, ok := mwic.mutation.Ints(); !ok {
		return &ValidationError{Name: "ints", err: errors.New(`ent: missing required field "MessageWithInts.ints"`)}
	}
	return nil
}
...
func (mwic *MessageWithIntsCreate) createSpec() (*MessageWithInts, *sqlgraph.CreateSpec) {
	...
	if value, ok := mwic.mutation.Ints(); ok {

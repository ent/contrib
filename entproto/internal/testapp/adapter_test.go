...
func (suite *AdapterTestSuite) TestValidMessage() {
	...
	suite.Equal("entgo.io/contrib/entproto/internal/testapp/ent/proto/entpb",
...
func (suite *AdapterTestSuite) TestMessageWithPackageName() {
	...
	suite.Equal("entgo.io/contrib/entproto/internal/testapp/ent/proto/io/entgo/apps/todo",
		fd.GetFileOptions().GetGoPackage())
}

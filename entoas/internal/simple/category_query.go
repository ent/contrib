...
func (cq *CategoryQuery) sqlAll(ctx context.Context) ([]*Category, error) {
	...
	_spec.Assign = func(columns []string, values []interface{}) error {
		if len(nodes) == 0 {
			return fmt.Errorf("simple: Assign called without calling ScanValues")
		}
...
func (cgb *CategoryGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("simple: CategoryGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategoryGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoryGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("simple: CategoryGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategoryGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoryGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("simple: CategoryGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategoryGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoryGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("simple: CategoryGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategoryGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("simple: CategorySelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategorySelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("simple: CategorySelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategorySelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("simple: CategorySelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategorySelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("simple: CategorySelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("simple: CategorySelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

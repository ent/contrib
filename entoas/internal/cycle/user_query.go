...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	_spec.Assign = func(columns []string, values []interface{}) error {
		if len(nodes) == 0 {
			return fmt.Errorf("cycle: Assign called without calling ScanValues")
		}
...
func (ugb *UserGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("cycle: UserGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("cycle: UserGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("cycle: UserGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("cycle: UserGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Strings(ctx context.Context) ([]string, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("cycle: UserSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Ints(ctx context.Context) ([]int, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("cycle: UserSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("cycle: UserSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("cycle: UserSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("cycle: UserSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
